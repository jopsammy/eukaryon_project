...
<div class="eu-papers">
  ...
  <article class="eu-paper">
    <figure class="eu-paper__fig">
      <img src="{{ '/assets/img/papers/long-horizon-non-implication.png' | relative_url }}" alt="三段非蕴含链" />
      <figcaption class="eu-paper__figcap">
        单次能力强 ⇏ 单检查点可完成 ⇏ 跨检查点持续推进 ⇏ Benchmark 高分<br>
        Strong single-step ⇏ single-checkpoint closure ⇏ sustained progression ⇏ high benchmark scores
      </figcaption>
    </figure>
