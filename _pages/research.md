...
title: research / 研究
permalink: /research/
description: Eukaryon Project 三篇核心论文 / Three core publications of the Eukaryon Project
nav: true
nav_order: 1
---
...
<div class="eu-r_intro">
  <h2 class="eu-r_intro__h">三篇核心论文</h2>
  <p class="eu-r_intro__p">
    做出能在真实长程任务中持续工作的 Agent，需要回答三个问题：<b>为什么单次能力不够？结构下限如何工程化？治理的边界在哪？</b>三篇论文，一一作答，构成 Eureka Agent 的前置理论基础。
  </p>
  <p class="eu-r_intro__p eu-r_intro__p--en">
    To build an Agent that sustains real long-horizon work, three questions must be answered: <b>Why is single-shot capability insufficient? How to engineer the structural lower bound? Where do the boundaries of governance lie?</b> Three papers, three answers. Together they form the theoretical foundation for Eureka Agent.
  </p>
</div>
...
<div class="eu-papers">
  ...
  <article class="eu-paper">
    <figure class="eu-paper__fig">
      <img src="{{ '/assets/img/papers/long-horizon-six-conditions.png' | relative_url }}" alt="六条逻辑必要条件的依赖关系" />
      <figcaption class="eu-paper__figcap">
        六条逻辑必要条件之间的依赖关系：运载前提 → 回溯确定性 → 外部媒介适配 → 等距回溯 → 外部稳定 → 前向回溯<br>
        Dependency among the six logically necessary conditions
      </figcaption>
    </figure>
    <div class="eu-paper__body">
      <div class="eu-paper__num">01 · 长程实践</div>
  ...
  <article class="eu-paper">
    ...
    <div class="eu-paper__body">
      <div class="eu-paper__num">02 · AC 范式</div>
  ...
  <article class="eu-paper">
    <figure class="eu-paper__fig">
      <img src="{{ '/assets/img/papers/black-grail-three-layer-concentric.png' | relative_url }}" alt="原核/真核/皮层三层同心模型" />
      <figcaption class="eu-paper__figcap">
        原核（模型调用协议）→ 真核（治理基础设施）→ 皮层（外部系统接口）：Agent 系统的三层同心模型<br>
        Prokaryon → Eukaryon → Cortex: the three-layer concentric model of Agent systems
      </figcaption>
    </figure>
    <div class="eu-paper__body">
      <div class="eu-paper__num">03 · 黑圣杯</div>
...
<div class="eu-r_footer">
  理论已备。工程路线，见 <a href="{{ '/roadmap/' | relative_url }}">roadmap</a>。<br>
  The theory is ready. For engineering, see the <a href="{{ '/roadmap/' | relative_url }}">roadmap</a>.
</div>
